...
#define PduR_GetSizeOfRmDestRomOfPCConfig()                           3u  /**< the number of accomplishable value elements in PduR_RmDestRom */
#define PduR_GetSizeOfRmGDestRomOfPCConfig()                          3u  /**< the number of accomplishable value elements in PduR_RmGDestRom */
#define PduR_GetSizeOfRmSrcRomOfPCConfig()                            3u  /**< the number of accomplishable value elements in PduR_RmSrcRom */
...
#define PduR_GetRmGDestRomEndIdxOfMmRom(Index)                        ((PduR_RmGDestRomEndIdxOfMmRomType)((((PduR_RmGDestRomEndIdxOfMmRomType)(Index)) + 2u)))  /**< the end index of the 0:n relation pointing to PduR_RmGDestRom */
