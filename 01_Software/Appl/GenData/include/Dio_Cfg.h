...
*
*/
#define DioConf_DioPort_DioPort_PortA  ((uint8)0x00U)
...
*
*/
#define DioConf_DioPort_DioPort_PortB  ((uint8)0x01U)
...
/**
* @brief          Symbolic name for the channel DioChannel_LEDB_4_PTD0_P4.
*
*/


/** @violates @ref Dio_Cfg_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define  DioConf_DioChannel_DioChannel_LEDB_4_PTD0_P4 ((uint16)0x0060U)

/**
* @brief          Symbolic name for the channel DioChannel_LEDR_2_PTD15_P22.
*
*/


/** @violates @ref Dio_Cfg_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define  DioConf_DioChannel_DioChannel_LEDR_2_PTD15_P22 ((uint16)0x006fU)

/**
* @brief          Symbolic name for the channel DioChannel_LEDY_3_PTD1_P3.
*
*/


/** @violates @ref Dio_Cfg_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define  DioConf_DioChannel_DioChannel_LEDY_3_PTD1_P3 ((uint16)0x0061U)

/**
* @brief          Symbolic name for the channel DioChannel__LEDG_1_PTD16_P21.
*
*/


/** @violates @ref Dio_Cfg_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define  DioConf_DioChannel_DioChannel__LEDG_1_PTD16_P21 ((uint16)0x0070U)

/* ---------- DioPort_PortE ---------- */

/**
* @brief          Symbolic name for the port DioPort_PortE.
*
*/
#define DioConf_DioPort_DioPort_PortE  ((uint8)0x04U)
